"""Append-only protocol guard for the cheap exhaustive hypothesis tournament."""
...
PREREGISTRATION = REPO_ROOT / "docs" / "forex" / "fast10-preregistration.md"
REGISTRY = REPO_ROOT / "docs" / "forex" / "fast10-registry.jsonl"
