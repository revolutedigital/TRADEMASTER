"""Append-only protocol guard for the centralized executed-flow pilot."""
...
PREREGISTRATION = REPO_ROOT / "docs" / "forex" / "fast11-preregistration.md"
REGISTRY = REPO_ROOT / "docs" / "forex" / "fast11-registry.jsonl"
