"""Append-only protocol guard for managed executed-flow hypotheses."""
...
PREREGISTRATION = REPO_ROOT / "docs" / "forex" / "fast12-preregistration.md"
REGISTRY = REPO_ROOT / "docs" / "forex" / "fast12-registry.jsonl"
