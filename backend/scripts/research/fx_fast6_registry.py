"""Append-only protocol guard for the ranked-entry runner study."""
...
PREREGISTRATION = REPO_ROOT / "docs" / "forex" / "fast6-preregistration.md"
REGISTRY = REPO_ROOT / "docs" / "forex" / "fast6-registry.jsonl"
