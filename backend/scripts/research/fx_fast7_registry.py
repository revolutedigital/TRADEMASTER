"""Append-only protocol guard for the early-protection runner study."""
...
PREREGISTRATION = REPO_ROOT / "docs" / "forex" / "fast7-preregistration.md"
REGISTRY = REPO_ROOT / "docs" / "forex" / "fast7-registry.jsonl"
