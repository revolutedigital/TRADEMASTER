"""Append-only protocol guard for the managed-payoff expectation study."""
...
PREREGISTRATION = REPO_ROOT / "docs" / "forex" / "fast9-preregistration.md"
REGISTRY = REPO_ROOT / "docs" / "forex" / "fast9-registry.jsonl"
